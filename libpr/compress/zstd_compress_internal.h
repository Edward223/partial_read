...
struct ZSTD_MatchState_t {
  ...
  U32 loadedDictEnd;    /* index of end of dictionary, within context's
                         ...
                         * is    no longer    within    distance.    Such mechanism
                         * is    provided within    ZSTD_window_enforceMaxDist()
                         * and    ZSTD_checkDictValidity().    When dict
                         * referential    is    copied into active context (i.e.
                         * not    attached),    loadedDictEnd == dictSize, since
                         * referential    starts from    zero.
                         */
